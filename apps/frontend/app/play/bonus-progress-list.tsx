...
interface BonusProgressListProps {
  ...
  /** False while showing the quiz's last break — bonuses have already closed by then, so the "available" section is hidden entirely (earned custom awards still show). */
...
export function BonusProgressList({
  ...
  return (
    <div className="flex flex-col gap-2.5">
      {showAvailability && predefinedCategories.length > 0 && (
        <>
