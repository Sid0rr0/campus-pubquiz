...
const PAYLOAD = {
  pending: [{ id: 5, username: 'bob', role: 'moderator' as const, status: 'pending' as const, createdAt: '2026-01-01T00:00:00.000Z' }],
  active: [{ id: 1, username: 'alice', role: 'admin' as const, status: 'active' as const, createdAt: '2026-01-01T00:00:00.000Z' }],
  deactivated: [],
};
...
describe('UsersPanel', () => {
  ...
  it('approves a pending user with the selected role', async () => {
    ...
    await waitFor(() => expect(mockApproveUser).toHaveBeenCalledWith(5, 'admin'));
